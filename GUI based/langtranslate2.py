...
def lang_translate(cursor):
    ...
    #Create Chat window
    ChatLog = Text(top, bd=0, bg="gray71", height="8", width="50", font="Montserrat",)
    ...
    EntryBox = Text(top, bd=0, bg="gray81",width="29", height="5", font="Montserrat")
    ...
    def send():
        ...
        if msg != '':
            ...
            wraplength=200, font=("Montserrat", 10, "bold"), bg="medium purple", bd=4, justify="left"))
            ChatLog.insert(END,'\n ', "left")
            ChatLog.config(foreground="#0000CC", font=("Montserrat", 9))
            ChatLog.yview(END)
    ...
    def receive(response):        
        ...
        wraplength=200, font=("Montserrat", 10, "bold"), bg="gray87", bd=4, justify="left"))
        ChatLog.insert(END, '\n ', "right")
        ChatLog.config(state=DISABLED)
        #ChatLog.insert(END, '\n ', "right")
        ChatLog.yview(END)
